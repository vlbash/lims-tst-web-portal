...
def test_lims_test_case_2_1(app):
    app.session.login(password='111',
                      path_to_key='/home/ps/MyFiles/projects/lims-tst-web-portal/tools/98745612_7878789898_DU180323123055.ZS2')
    ...
    app.first_application.dossier_file(version='Тест досьє',
                             comment='Тест коментар',
                             date_to='19.04.2025',
                             path_to_file='/home/ps/MyFiles/projects/lims-tst-web-portal/tools/masloy.png')
