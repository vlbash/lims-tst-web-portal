...
def test_lims_test_case_2_1(app):
    ...
    app.session.create_first_application(pib="Ступка Богдан Сильвестрович",
                                         email="test@test.ua",
                                         ...
                                         duns_number="56789")
    app.session.create_mpd(company_name='Тест',
                           phone_number='+380123456789',
                           email='test@test.ua',
                           fax_number='+380123456789',
                           city="Дніпро",
                           ...
                           adress='Test',
                           building='13')
    app.session.contract_contractors(edrpou='12345678',
                                     name_contractor='Тест',
                                     adress='Тест')
    app.session.authorized_persons(person_name='Тест',
    ...
    app.session.dossier_file(version='Тест досьє',
                             comment='Тест коментар',
                             date_to='19.04.2025',
                             path_to_file='C:/masloy.png')
    app.session.completeness_check()
    app.session.notifications_and_license_terms(comment='Коментар тест')
    app.session.submit_application(path_to_key='C:/98745612_7878789898_DU180323123055.ZS2',
                                   password='111')
